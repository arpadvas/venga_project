		...
		if(req.body.name === null ||
			...
			if(err) {
				...
				var email = {
				  ...
				  text: 'Hello ' + user.name + ', Please click on the following link in order to activate your account: https://enigmatic-earth-37786.herokuapp.com/activate/' + user.temporarytoken,
				  html: 'Hello ' + user.name + ', Please click on the following link in order to activate your account: <a href="https://enigmatic-earth-37786.herokuapp.com/activate/' + user.temporarytoken + '">link</a>'
				};
				...
				user.save(function(err) {
					if (err) {
						...
						var email = {
						  ...
						  text: 'Hello ' + user.name + ', Please click on the following link to reset your password: https://enigmatic-earth-37786.herokuapp.com/reset/' + user.resettoken,
						  html: 'Hello ' + user.name + ', Please click on the following link to reset your password: <a href="https://enigmatic-earth-37786.herokuapp.com/reset/' + user.resettoken + '">link</a>'
						};
