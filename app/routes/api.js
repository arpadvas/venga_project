...
//ascent-search////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	// router.get('/ascentscount/:nameKeyword/:styleKeyword/:gradeKeyword/:senderKeyword', function(req, res) {
	// 	if (req.params.gradeKeyword) {
	// 		Ascent.count({ name: { $regex: req.params.nameKeyword, $options: "i" }, style: { $regex: req.params.styleKeyword, $options: "i" }, grade: { $eq: req.params.gradeKeyword }, sentByName: { $regex: req.params.senderKeyword, $options: "i" } }, function(err, count) {
	// 			if (err) throw err;
	// 			if (!count) {
	// 				res.json({success: false, message: 'No ascent was found!'});
	// 			} else {
	...
	// 			}
	// 		});
	// 	} else if (req.params.gradeKeyword === '') {
	// 		Ascent.count({ name: { $regex: req.params.nameKeyword, $options: "i" }, style: { $regex: req.params.styleKeyword, $options: "i" }, grade: { $regex: req.params.gradeKeyword }, sentByName: { $regex: req.params.senderKeyword, $options: "i" } }, function(err, count) {
	// 			if (err) throw err;
	// 			if (!count) {
	// 				res.json({success: false, message: 'No ascent was found!'});
	// 			} else {
	...
	router.post('/ascentscount', function(req, res) {
		if (req.body.gradeKeyword) {
